...
NOISE = {
    "number", "numbers", "id", "identifier", "identification", "code", "no",
    "the", "of", "and", "individual", "personal", "national", "government",
}
...
COUNTRY = {
    ...
    "usa": "us", "us": "us", "united states": "us", "america": "us", "american": "us",
    "canada": "ca", "canadian": "ca", "brazil": "br", "brazilian": "br",
    "india": "in", "indian": "in", "australia": "au", "australian": "au",
    "japan": "jp", "japanese": "jp", "korea": "kr", "korean": "kr",
    "mexico": "mx", "mexican": "mx", "china": "cn", "chinese": "cn",
    "argentina": "ar", "israel": "il", "turkey": "tr", "turkish": "tr",
    "portugal": "pt", "ireland": "ie", "irish": "ie", "singapore": "sg",
    "switzerland": "ch", "swiss": "ch", "sweden": "se", "swedish": "se",
    "norway": "no", "denmark": "dk", "finland": "fi", "belgium": "be",
    "austria": "at", "greece": "gr", "greek": "gr", "romania": "ro",
    "czech": "cz", "hungary": "hu", "indonesia": "id", "thailand": "th",
    "thai": "th", "vietnam": "vn", "philippines": "ph", "malaysia": "my",
    "new zealand": "nz", "south africa": "za", "nigeria": "ng", "egypt": "eg",
    "russia": "ru", "ukraine": "ua", "colombia": "co", "chile": "cl", "peru": "pe",
}

# The concept behind a dozen different spellings.
CONCEPT = {
    "passport": "passport", "driver": "driving-licence", "drivers": "driving-licence",
    "driving": "driving-licence", "licence": "driving-licence", "license": "driving-licence",
    "tax": "tax", "vat": "vat", "fiscal": "tax", "nif": "tax", "tin": "tax",
    "phone": "phone", "telephone": "phone", "mobile": "phone", "fax": "phone",
    "postal": "postal", "zip": "postal", "postcode": "postal", "post": "postal",
    "iban": "iban", "swift": "swift", "bic": "swift", "bank": "bank-account",
    "account": "bank-account", "routing": "bank-routing", "sort": "sort-code",
    "credit": "payment-card", "card": "payment-card", "debit": "payment-card",
    "cvv": "card-security", "pin": "card-security",
    "ssn": "social-security", "social": "social-security", "insurance": "social-security",
    "medicare": "health", "medicaid": "health", "health": "health", "nhs": "health",
    "patient": "health", "dea": "health", "npi": "health", "hpi": "health",
    "email": "email", "mail": "email",
    "ip": "ip", "ipv4": "ip", "ipv6": "ip", "mac": "mac",
    "imei": "imei", "imsi": "imsi", "vin": "vin", "vehicle": "vehicle",
    "registration": "registration", "plate": "vehicle",
    "birth": "date-of-birth", "date": "date", "age": "age",
    "name": "name", "firstname": "name", "lastname": "name", "surname": "name",
    "address": "address", "street": "address", "city": "address",
    "gender": "gender", "sex": "gender", "race": "race", "ethnic": "race",
    "religion": "religion", "political": "political", "sexual": "sexual-orientation",
    "biometric": "biometric", "fingerprint": "biometric", "dna": "biometric",
    "key": "credential", "token": "credential", "secret": "credential",
    "password": "credential", "credential": "credential", "oauth": "credential",
    "certificate": "certificate", "jwt": "credential",
    "crypto": "crypto-wallet", "bitcoin": "crypto-wallet", "ethereum": "crypto-wallet",
    "wallet": "crypto-wallet",
    "residence": "residence-permit", "permit": "residence-permit",
    "voter": "voter", "military": "military", "student": "student",
    "employee": "employee", "salary": "salary", "url": "url", "username": "username",
}

# Our own labels, described in the same vocabulary, so the two sides compare.
OURS = {
    "EMAIL": ("", "email"), "URL": ("", "url"), "IPV4": ("", "ip"), "IPV6": ("", "ip"),
    "MAC_ADDRESS": ("", "mac"), "CREDIT_CARD": ("", "payment-card"), "IBAN": ("", "iban"),
    "PHONE_INTERNATIONAL": ("", "phone"), "BTC_ADDRESS": ("", "crypto-wallet"),
    "ETH_ADDRESS": ("", "crypto-wallet"), "EU_VAT": ("eu", "vat"),
    "PRIVATE_KEY_BLOCK": ("", "credential"), "JWT": ("", "credential"),
    "BEARER_TOKEN": ("", "credential"), "OPENAI_API_KEY": ("", "credential"),
    "ANTHROPIC_API_KEY": ("", "credential"), "GOOGLE_API_KEY": ("", "credential"),
    "AWS_ACCESS_KEY": ("", "credential"), "AWS_SECRET_ACCESS_KEY": ("", "credential"),
    "AZURE_STORAGE_KEY": ("", "credential"), "GITHUB_TOKEN": ("", "credential"),
    "SLACK_TOKEN": ("", "credential"), "STRIPE_KEY": ("", "credential"),
    "SENDGRID_API_KEY": ("", "credential"), "TWILIO_SID": ("", "credential"),
    "NPM_TOKEN": ("", "credential"), "PYPI_TOKEN": ("", "credential"),
}
for label in LABELS:
    if label in OURS:
        continue
...
UNREACHABLE = {
    "name", "address", "age", "date", "gender", "race", "religion", "political",
    "sexual-orientation", "biometric", "salary", "username", "employee", "student",
    "military", "occupation", "nationality", "date-of-birth",
}
...
covered = [k for k in demand if k[1] in ours_concepts and (not k[0] or k[0] in ours_concepts[k[1]])]
